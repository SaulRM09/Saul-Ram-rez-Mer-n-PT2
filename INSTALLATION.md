...
#### 1.1 Configurar una màquina virtual per allotjar Nextcloud
Després d’haver creat la màquina virtual, cal preparar l’entorn perquè sigui possible instal·lar-hi Nextcloud. Per fer-ho, haurem de seguir els passos que s’indiquen a continuació.
